...
st.markdown("##### Powered by Llama 3.2 90b on GROQ: Built by [HUBRIS](https://hubris.at)")
st.markdown("##### Disclaimer: The information generated by this app is for informational purposes only and is not investment advice. Always consult a financial advisor before making decisions. We are not liable for any actions taken based on the app's output.")
...
def main() -> None:
    ...
    # Get LLM Model
    model = (
        st.sidebar.selectbox("Select LLM", options=["llama-3.1-70b-versatile","llama-3.1-8b-instant","llama3-70b-8192", "llama3-8b-8192", "llama-3.2-90b-text-preview", "llama-3.2-11b-text-preview"])
